...
1. **Commit + push** all of this (user must say the word) → Vercel auto-deploys. ~28 files: 6 modified pages/layout, 6 new components, 23 deletions. Suggested msg: "redesign: Polymath monochrome system across consulting, engineering, home, book".
2. Verify prod after deploy: /consulting chatbot against Azure agent-service, /book connected:true, /engineering chat.
