...
const VARIANTS: {
...
}[] = [
  {
    ...
    subtitle: "Hands-on build: real-time inference, agents, RAG, MLOps",
    targets: ["Real-time ML", "Agents", "RAG", "MLOps", "AWS", "On-prem AI"],
    highlights: [
  ...
  },
  {
    ...
    subtitle: "Reliability audits, production hardening, fractional AI lead",
    targets: ["Discovery", "AI roadmaps", "Reliability", "Eval", "Cost control", "Architecture"],
    highlights: [
      { metric: "4",       label: "Industries consulted" },
      { metric: "0 bytes", label: "Data egress (Lawline)" },
      { metric: "10+",     label: "Startups advised" },
      { metric: "60–80%",  label: "Dev time is eval" },
    ],
